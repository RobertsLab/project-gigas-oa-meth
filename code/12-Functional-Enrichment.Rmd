...
```{r}
sigRes.allCC <- allRes.allCC[1:10,c(1, 6)] #Filter significantly enriched GOterms, only keep GOID and p-value
...
length(unique(sigRes.allCCAnnot$geneID)) #20 unique genes
length(unique(sigRes.allCCAnnot$transcript)) #42 unique genes
