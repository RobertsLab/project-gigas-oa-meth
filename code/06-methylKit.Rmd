...
sampleMetadata <- data.frame("sampleID" = c("1", "2", "3", "4",
                             ...
                             "pHTreatment" = c(rep(1, times = 4),
                                               rep(0, times = 4))) #Create dataframe with metadata. 1 = low, 0 = ambient
...
differentialMethylationStatsTreatment <- methylKit::calculateDiffMeth(methylationInformationFilteredCov5,
                                                                      mc.cores = 4) #Calculate differential methylation statistics based on treatment indication from methRead. Use 4 cores.
...
I don't have covariate information (tank, wet weight, shell length) for all samples, since some tissues were mixed up during histology processing. I am going to keep samples I have covariate information for, then perform the analysis. Common DML between the two analyses will give me more confidence in my data.

```{r}
covariateMetadata <- data.frame("ploidy" = c(rep("2N", times = 12), 
