...
I have three female samples and one indeterminate sample per treatment. I will analyze these datasets separately.
...
```{r}
sampleMetadata <- data.frame("sampleID" = c("1", "3", "4",
                                            "6", "7", "8"),
                             "slide-label" = c("02-T1", "06-T1", "08-T2",
                                               "UK-02", "UK-04", "UK-06"),
                             "pHTreatment" = c(rep(1, times = 3),
                                               rep(0, times = 3))) #Create dataframe with metadata. 1 = low, 0 = ambient. Slide label information from histology processing
...
abline(v = nrow(diffMethStatsTreatment25)) #Add a vertical line for the number of DML identified with getMethylDiff
dev.off()
```
...
abline(v = nrow(diffMethStatsTreatment50)) #Add a vertical line for the number of DML identified with getMethylDiff
dev.off()
```
