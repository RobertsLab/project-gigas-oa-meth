...
knitr::opts_knit$set(root.dir = "../output/06-methylKit/") #Set root directory
```
...
`methylKit` creates PCA biplots, but I want to create a custom biplot and multiplanel figure with the PCA and correlation plot to visualize the comparative analysis results.
