...
covariateMetadata <- data.frame("stage" = c("2", "0", "1", "1",
                                            "0", "1", "2", "3"),
                                "sex" = c("F", "I", "F", "F",
                                          "I", "F", "F", "F")) #Create dataframe with stage and sex information. 0/I = intederminate, F = female, 1/2/3 = early female maturation
...
differentialMethylationStatsTreatment <- methylKit::calculateDiffMeth(methylationInformationFilteredCov5,
                                                                      ...
                                                                      mc.cores = 4) #Calculate differential methylation statistics and include covariate information. Use 4 cores.
