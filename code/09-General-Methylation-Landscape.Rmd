...
knitr::opts_knit$set(root.dir = "/Users/yaaminivenkataraman/Documents/project-gigas-oa-meth/output/09-methylation-landscape/") #Set root directory
```
...
```{r}
cpgMethylation <- read.table("zr3616_union-averages_5x.bedgraph.NO-SNPs", header = FALSE, sep = "\t") #Import  bedgraph with percent methylation information for all CpGs with 5x coverage in each sample
