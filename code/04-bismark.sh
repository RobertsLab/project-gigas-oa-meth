#!/bin/bash
## Job Name
#SBATCH --job-name=manchester-bismark
...
#SBATCH --chdir=/gscratch/scrubbed/yaaminiv/Manchester/analyses/bismark
...
genome_folder="/gscratch/scrubbed/yaaminiv/Manchester/data/Crassostrea_gigas.oyster_v9.dna_sm.toplevel/"
