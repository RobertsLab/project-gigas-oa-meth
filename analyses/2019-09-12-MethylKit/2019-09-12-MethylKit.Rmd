...
```{r}
methylationInformationFilteredCov5DestrandReduced$start <- (methylationInformationFilteredCov5DestrandReduced$start - 1) #Subtract 2 from the start position for visualization
...
```{r}
DML5x100diffFilteredDestrand09122019 <- mutate(diffMethStats100FilteredCov5Destrand, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
...
```{r}
DML5x100diffFilteredDestrandHyper09122019 <- mutate(diffMethStats100FilteredCov5DestrandHyper, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
...
```{r}
DML5x100diffFilteredDestrandHypo09122019 <- mutate(diffMethStats100FilteredCov5DestrandHypo, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
...
```{r}
DML10xFilteredDestrand09122019 <- mutate(diffMethStats50FilteredCov10Destrand, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
```
...
```{r}
DML10xFilteredDestrandHyper09122019 <- mutate(diffMethStats50FilteredCov10DestrandHyper, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
```
...
```{r}
DML10xFilteredDestrandHypo09122019 <- mutate(diffMethStats50FilteredCov10DestrandHypo, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
```
...
```{r}
DML10x100diffFilteredDestrand09122019 <- mutate(diffMethStats100FilteredCov10Destrand, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
...
```{r}
DML10x100diffFilteredDestrandHyper09122019 <- mutate(diffMethStats100FilteredCov10DestrandHyper, start = start -1, end = end + 1) %>% select(chr, start, end, meth.diff) %>% mutate_if(is.numeric, as.integer) #Save as a BED file, and avoid writing information in scientific notation
