...
DMLGeneAnnotations <- DMLGeneAnnotations[,c(1:3, 6)] #Only keep the indicated columns
colnames(DMLGeneAnnotations) <- c("Uniprot", "geneID", "evalue", "Product") #Add column names
