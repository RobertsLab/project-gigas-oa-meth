...
# Create biological process plots
...
par(mar = c(5, 14, 1, 1)) #Change figure boundaries
...
axis(side = 2, at = barsGOSlim, labels = BPGOSlimCounts$GOSlim, tick = FALSE, las = 2, col = "grey80", cex.lab = 1.5) #Add y-axis with GOSlim terms from BPGOSlimCounts. Place labels at specific barplot values from barsGOSlim. Remove tick marks (tick) and change orientation of labels (las)
