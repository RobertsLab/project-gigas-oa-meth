...
```{r}
plotColors <- rev(RColorBrewer::brewer.pal(5, "Purples")) #Create a color palette for the barplots. Use 5 purple shades from RColorBrewer. Reverse the order so the darkest shade is used first.
